...
class LatinKeyboard : Keyboard {
    ...
    private var mCalculatorKey: Keyboard.Key? = null
    ...
    override fun createKeyFromXml(
        res: Resources, parent: Keyboard.Row, x: Int, y: Int,
        ...
        } else if (key.codes[0] == LatinKeyboardView.KEYCODE_CALCULATOR) {
            mCalculatorKey = key
            mCalculatorKey = LatinKey(res, parent, x, y, parser)
        }
        return key
    }
...
//            }
            ...
            EditorInfo.IME_ACTION_DONE -> {
                mEnterKey!!.icon = res.getDrawable(R.drawable.icon_done_orange)
                mEnterKey!!.label = null
            }
            EditorInfo.IME_ACTION_SEND -> {
                ...
                mEnterKey!!.icon = res.getDrawable(R.drawable.icon_enter)
                mEnterKey!!.label = null
            }
        }
    }
